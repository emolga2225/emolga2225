...
def load_all_frames_from_h5(h5_path, max_sinusoids_per_frame=900):
    """
...
def main():
    ...
    parser.add_argument('--max-sinusoids', type=int, default=900,
                       help='Max sinusoids per frame (optimized from density analysis)')
